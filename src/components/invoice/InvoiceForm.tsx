...
// --- REMOVE THIS LINE: import { Invoice } from './InvoiceList'; // Adjust path if necessary
...
const API_BASE_URL = 'https://madebyquantbackend.onrender.com'; // Define your API base URL
...
export function InvoiceForm({ invoice, onClose, onSubmitSuccess }: InvoiceFormProps) {
  ...
  }, [invoice, toast, initialInvoiceDate]);
